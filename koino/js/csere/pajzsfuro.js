...
// ⚠️ ITT ÁLLT 2026-09-26-IG A KÜLSŐ CÍM TCP-N (`TCP_TUKROK`, `kulsoCimTcp`, 18. mérés) — a
// TCP-fúrónak kellett. A D69/2 óta nincs TCP a készülékek között (Csaba döntése).
...
// ⚠️ ITT ÁLLT 2026-09-26-IG A TCP-PAJZSFÚRÁS (`tcpPajzsfuras`, 19. mérés: átment, mert a
// router célfüggetlen). ⛔ A D69/2-vel kikerült: a TCP-fúrás a router célfüggetlenségén áll,
// a UDP a foglalat-modellen — egymilliárdnál a router-eltérés alapállapot (9. szabály).
