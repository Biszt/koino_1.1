...
Tizenöt próba-fájl, **446 önpróba**; a kilépési kód 1, ha bármi bukott. Egy réteg külön is
...
ellenőrizhető, hogy friss. *(Ugyanez a mappa mérete: ma **126 fájl, 1747,5 KB**, nulla
npm-csomag.)*
