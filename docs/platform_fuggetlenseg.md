...
| **6** | ⭐ **Nulla függőség, kis méret.** Ma **73 KB, 26 fájl, 0 npm-csomag**. Ez már **nem elegancia, hanem védelem**: elfér egy üzenetben, és bárki újraírhatja. Minden új függőség egy újabb fojtópont (csomagtár, regisztráció, letiltás). | `find koino -type f \| wc -l`, `du -sh koino` |
