...
Tizennyolc próba-fájl, **516 önpróba**; a kilépési kód 1, ha bármi bukott. Egy réteg külön is
...
ellenőrizhető, hogy friss. *(Ugyanez a mappa mérete: ma **161 fájl, 2334,5 KB**, nulla
npm-csomag.)*
