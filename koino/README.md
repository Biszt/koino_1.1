...
Tizenhárom próba-fájl, **379 önpróba**; a kilépési kód 1, ha bármi bukott. Egy réteg külön is
...
ellenőrizhető, hogy friss. *(Ugyanez a mappa mérete: ma **123 fájl, 1564,9 KB**, nulla
npm-csomag.)*
