...
Tizenhárom próba-fájl, **400 önpróba**; a kilépési kód 1, ha bármi bukott. Egy réteg külön is
...
ellenőrizhető, hogy friss. *(Ugyanez a mappa mérete: ma **123 fájl, 1621,5 KB**, nulla
npm-csomag.)*
