...
Huszonegy próba-fájl, **557 önpróba**; a kilépési kód 1, ha bármi bukott. Egy réteg külön is
...
ellenőrizhető, hogy friss. *(Ugyanez a mappa mérete: ma **168 fájl, 2426,1 KB**, nulla
npm-csomag.)*
