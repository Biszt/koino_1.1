...
Tizenöt próba-fájl, **431 önpróba**; a kilépési kód 1, ha bármi bukott. Egy réteg külön is
...
ellenőrizhető, hogy friss. *(Ugyanez a mappa mérete: ma **126 fájl, 1712,0 KB**, nulla
npm-csomag.)*
