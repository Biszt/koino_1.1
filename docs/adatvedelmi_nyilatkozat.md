...
**Levelet magamtól soha nem küldök.** Ha megadtad a címed, három dologra
használható, és mindháromhoz a te kérésed kell:

- **bejelentkezésre** (az e-embernév helyett a címeddel is beléphetsz),
- **elfelejtett jelszó** esetén — ha te kéred a bejelentkezés oldalon,
- **értesítésekre**, ha ezt a beállításokban bekapcsolod (és bármikor kikapcsolhatod).

A cím megerősítéséig (egy hivatkozás, amit te kérsz) **semmilyen levél nem megy ki**
