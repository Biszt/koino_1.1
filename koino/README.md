...
Kilenc próba-fájl, **198 önpróba**; a kilépési kód 1, ha bármi bukott. Egy réteg külön is
...
| **E** pajzsfúrás + UDP-szállítás | ⭐⭐⭐ **KÉSZ** (2026-08-29 22:54): két háztartás, CGNAT mögül is, **83 ms alatt átfúrva — és a CSERE IS ÁTMENT** rajta (2 esemény, címjegyzék, tükör) |
