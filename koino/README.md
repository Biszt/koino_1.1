...
Tizennégy próba-fájl, **412 önpróba**; a kilépési kód 1, ha bármi bukott. Egy réteg külön is
...
ellenőrizhető, hogy friss. *(Ugyanez a mappa mérete: ma **125 fájl, 1651,9 KB**, nulla
npm-csomag.)*
