// koino/felulet/js/components/modals/ErtesitesiBeallitasModal.js
...
const ErtesitesiBeallitasModal = helyorzoModal('Értesítési beállítások');

export default ErtesitesiBeallitasModal;
export { ErtesitesiBeallitasModal };