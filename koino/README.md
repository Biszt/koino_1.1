...
Tizenöt próba-fájl, **425 önpróba**; a kilépési kód 1, ha bármi bukott. Egy réteg külön is
...
ellenőrizhető, hogy friss. *(Ugyanez a mappa mérete: ma **126 fájl, 1696,2 KB**, nulla
npm-csomag.)*
