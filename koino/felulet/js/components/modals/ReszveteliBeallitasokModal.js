// koino/felulet/js/components/modals/ReszveteliBeallitasokModal.js
...
const ReszveteliBeallitasokModal = helyorzoModal('Részvételi beállítások');

export default ReszveteliBeallitasokModal;
export { ReszveteliBeallitasokModal };