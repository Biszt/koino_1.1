...
function reszekSzamitasa(javaslatEsemeny, kik, szavazatok, tudatpontok, ertekJavaslatEsemenyek) {
   ...
   *
   * ⚠️ A szűrő a BEADOTT érték javaslatokon megy végig, nem a tulajdonosokon: aki nem adott
   * be sajátot, az nem szerepel a mediánban. Az `ALAP_KUSZOBOK` tehát tartalék, nem súly.
   * *(Megmérve: `meres/kuszobMeres.js`, az `eredmenyek.md` 14. szakasza.)*
   */
